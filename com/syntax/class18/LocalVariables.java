...
public class LocalVariables {
	...
	void displayName() {
			// System.out.println(name);// CE: name cannot be resolved to variable 
										// name is not visible to the displayName methods because it local to main
		}
		
	
	// create a method to return sum of 2 numbers
		int sum(int num1, int num2) { // num1 and num2 local variable to method sum
			return num1 + num2;
		}
		
		double div(double num1, double num2) { // num1 and num2 local variable to method divide
			return num1/num2;
		}
