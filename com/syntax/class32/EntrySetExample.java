...
public class EntrySetExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("-------Retrieving Key and Values pair from Entry using for Loop---------");
		for(Entry<Integer,String> ent: entries) {
			System.out.println(ent.getKey() + " ==== " + ent.getValue());
		}
		
		System.out.println("-------Retrieving Key and Values pair from Entry using for Iterator---------");
